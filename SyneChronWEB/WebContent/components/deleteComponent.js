...
function deleteController(authorService, bookService, authenticationService, $scope, $location){
	var vm = this;
	...
	template : `
		         ...
		         <div class="col-sm-12 col-md-7 noPadNoMorg-sm settings-box-container">
		            ...
		            <div class="settings-box">
                       ...
                       <div class="settings-right right">
							<p id="quantity-selector" class="right" ng-model="$ctrl.book.quantity">{{$ctrl.book.quantity}}</p>
		               </div>
		            </div>
